...
public class KafkaToPostgresAndRedisLatenessTriggering implements Serializable {
    transient BeamManager beamManager = new BeamManager();

    public static void main(String[] args) {
        new KafkaToPostgresAndRedisLatenessTriggering().invoke();
    }
    ...
    void invoke() {
        ...
        writeTimeToRedis(eventPCollection, KafkaToPostgresAndRedisLatenessTriggering.MeasurementTimeRange.PER_DAY);
        writeTimeToRedis(eventPCollection, KafkaToPostgresAndRedisLatenessTriggering.MeasurementTimeRange.PER_HOUR);
        writeTimeToRedis(eventPCollection, KafkaToPostgresAndRedisLatenessTriggering.MeasurementTimeRange.PER_MINUTE);
